                            ...
                            <div className="w-full flex items-center gap-3 group/search">
                                ...
                                <div className="relative flex-1">
                                    <input
                                        ...
                                        placeholder=""
                                        className="w-full px-4 py-2.5 !bg-transparent backdrop-blur-md border border-white/5 rounded-xl text-sm text-white font-medium focus:outline-none focus:border-primary/30 transition-all !shadow-none ring-0"
                                    />
                                </div>
                            </div>
                        )}
