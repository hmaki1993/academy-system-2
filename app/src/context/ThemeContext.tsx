...
export const defaultSettings: GymSettings = {
    ...
    login_card_border_color: 'rgba(255, 255, 255, 0.1)',
    ...
    login_mobile_card_border_color: 'rgba(255, 255, 255, 0.1)',
    login_mobile_accent_color: '#A30000',
...
export const USER_SPECIFIC_KEYS: (keyof GymSettings)[] = [
    ...
    'notify_sounds', 'notify_payments', 'notify_absences', 'notify_registrations', 'notify_browser_push'
];
        ...
        try {
            ...
            if (hasGymUpdates) {
                ...
                if (existingGym) {
                    ...
                    // Insert new row
                    console.log('💾 No gym_settings row found, creating one...');
                    const { error } = await supabase
                        .from('gym_settings')
                        .insert([gymPayload]);
                    gymError = error;
