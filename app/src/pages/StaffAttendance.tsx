        ...
        <div className="p-4 sm:p-8 max-w-[1600px] mx-auto space-y-8 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col gap-4 mb-2">
                ...
                <PageHeader
                    ...
                    subtitle="Monitor coaches and staff presence"
                >
                    <div className="flex items-center gap-3 w-full sm:w-auto group">
                        <Search className="h-4 w-4 text-white/30 group-focus-within:text-primary transition-colors shrink-0" />
                        <input
                            type="text"
                            value={searchStaff}
                            onChange={(e) => setSearchStaff(e.target.value)}
                            placeholder=""
                            className="w-full sm:w-64 bg-transparent backdrop-blur-md border border-white/10 text-white text-sm rounded-xl focus:ring-2 focus:ring-primary/50 focus:border-primary px-4 p-3 transition-all"
                        />
                    </div>
                </PageHeader>
            </div>
